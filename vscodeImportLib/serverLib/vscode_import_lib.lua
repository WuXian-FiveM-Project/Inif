...
--- Wait for promise to be resolve
-- @return A promise result
function Citizen.Await(promise)end

--- Create a couruntine
function Citizen.CreateThread()end

--- do something after the timeout
function Citizen.SetTimeout(delay, callback)end

--- log something to log.txt
function Citizen.Trace(str) end

--- wait a time in milliseconds
function Citizen.Wait(delay)end

--- get player all identifiers via Player ID
--- @return table identifier
function GetPlayerIdentifiers(src)end

--- get all players in game
--- @return table playersID all playersID
